...
class PageManager {
  ...
  Future<void> moveMediaItem(int currentIndex, int newIndex) async {
    return await (audioHandler as MediaHandler)
        .moveQueueItem(currentIndex, newIndex);
  }

  Future<void> removeQueueItemAt(int index) async {
    return await (audioHandler as MediaHandler).removeQueueItemIndex(index);
  }
  ...
  Future<void> adds(List<MediaItem> mediaItems, int index) async {
    ...
    await (audioHandler as MediaHandler).setNewPlaylist(mediaItems, index);
  }
